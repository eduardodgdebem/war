...
const Game: React.FC = () => {
  ...
  const handleToggleCard = (cardSelected: boolean) => {
  ...
  const { players, currentPlayer, message, phase } = gameState;
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6">
      ...
      {phase !== "GAME_OVER" && (
        <GameHistory gameState={gameState} onUndo={undo} onRedo={redo} />
      )}

      <Board gameState={gameState} onTerritoryClick={handleTerritoryClick} />
